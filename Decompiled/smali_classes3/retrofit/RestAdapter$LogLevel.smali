...
.method static constructor <clinit>()V
    ...
    invoke-direct {v1, v2, v3}, Lretrofit/RestAdapter$LogLevel;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lretrofit/RestAdapter$LogLevel;->BASIC:Lretrofit/RestAdapter$LogLevel;

    new-instance v2, Lretrofit/RestAdapter$LogLevel;

    const-string v3, "HEADERS"

    const/4 v4, 0x2

    invoke-direct {v2, v3, v4}, Lretrofit/RestAdapter$LogLevel;-><init>(Ljava/lang/String;I)V

    sput-object v2, Lretrofit/RestAdapter$LogLevel;->HEADERS:Lretrofit/RestAdapter$LogLevel;

    new-instance v3, Lretrofit/RestAdapter$LogLevel;

    const-string v4, "HEADERS_AND_ARGS"

    const/4 v5, 0x3

    invoke-direct {v3, v4, v5}, Lretrofit/RestAdapter$LogLevel;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lretrofit/RestAdapter$LogLevel;->HEADERS_AND_ARGS:Lretrofit/RestAdapter$LogLevel;

    new-instance v4, Lretrofit/RestAdapter$LogLevel;

    const-string v5, "FULL"

    const/4 v6, 0x4

    invoke-direct {v4, v5, v6}, Lretrofit/RestAdapter$LogLevel;-><init>(Ljava/lang/String;I)V

    sput-object v4, Lretrofit/RestAdapter$LogLevel;->FULL:Lretrofit/RestAdapter$LogLevel;

    filled-new-array {v0, v1, v2, v3, v4}, [Lretrofit/RestAdapter$LogLevel;
