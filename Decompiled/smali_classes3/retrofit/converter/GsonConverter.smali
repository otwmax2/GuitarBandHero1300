...
.method public fromBody(Lretrofit/mime/TypedInput;Ljava/lang/reflect/Type;)Ljava/lang/Object;
    ...
    :try_start_1
    iget-object p0, p0, Lretrofit/converter/GsonConverter;->gson:Lcom/google/gson/Gson;

    invoke-virtual {p0, v2, p2}, Lcom/google/gson/Gson;->fromJson(Ljava/io/Reader;Ljava/lang/reflect/Type;)Ljava/lang/Object;
    ...
    :goto_0
    :try_start_3
    new-instance p1, Lretrofit/converter/ConversionException;

    invoke-direct {p1, p0}, Lretrofit/converter/ConversionException;-><init>(Ljava/lang/Throwable;)V
...
.method public toBody(Ljava/lang/Object;)Lretrofit/mime/TypedOutput;
    ...
    iget-object p0, p0, Lretrofit/converter/GsonConverter;->charset:Ljava/lang/String;

    invoke-direct {v0, p1, p0}, Lretrofit/converter/GsonConverter$JsonTypedOutput;-><init>([BLjava/lang/String;)V
    :try_end_0
