...
.method public run()V
    ...
    iget-object p0, p0, Lretrofit/CallbackRunnable$1;->val$wrapper:Lretrofit/ResponseWrapper;

    iget-object p0, p0, Lretrofit/ResponseWrapper;->response:Lretrofit/client/Response;

    invoke-interface {v0, v1, p0}, Lretrofit/Callback;->success(Ljava/lang/Object;Lretrofit/client/Response;)V
