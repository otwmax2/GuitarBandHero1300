...
.method private constructor <init>(Ljava/io/InputStream;ILjava/util/concurrent/ExecutorService;Z)V
    ...
    const-string p2, "bufferSizeInBytes <= 0, bufferSizeInBytes = %,d"
...
.method private skipInternal(J)J
    ...
    const-string p1, "Expected stateChangeLock to be locked"
...
.method private waitForAsyncReadComplete()V
    ...
    invoke-static {v1}, Lorg/apache/commons/io/input/Input;->toInterruptedIOException(Ljava/lang/InterruptedException;)Ljava/io/InterruptedIOException;
...
.method public close()V
    ...
    :try_start_2
    invoke-virtual {p0}, Lorg/apache/commons/io/input/ReadAheadInputStream;->shutdownAwait()Z
    :try_end_2
...
.method shutdownAwait()Z
    ...
    iget-object v0, p0, Lorg/apache/commons/io/input/ReadAheadInputStream;->executorService:Ljava/util/concurrent/ExecutorService;

    invoke-interface {v0}, Ljava/util/concurrent/ExecutorService;->shutdownNow()Ljava/util/List;

    iget-object p0, p0, Lorg/apache/commons/io/input/ReadAheadInputStream;->executorService:Ljava/util/concurrent/ExecutorService;
