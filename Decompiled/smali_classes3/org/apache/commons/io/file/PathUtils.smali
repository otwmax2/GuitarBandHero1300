...
.method public static directoryAndFileContentEquals(Ljava/nio/file/Path;Ljava/nio/file/Path;[Ljava/nio/file/LinkOption;[Ljava/nio/file/OpenOption;[Ljava/nio/file/FileVisitOption;)Z
    ...
    invoke-static {v4, v5}, Lorg/apache/commons/io/file/PathUtils;->isSameFileSystem(Ljava/nio/file/Path;Ljava/nio/file/Path;)Z
    ...
    :cond_5
    new-instance v2, Lorg/apache/commons/io/file/PathUtils$$ExternalSyntheticLambda7;

    invoke-direct {v2}, Lorg/apache/commons/io/file/PathUtils$$ExternalSyntheticLambda7;-><init>()V

    invoke-static {v2}, Ljava/util/Comparator;->comparing(Ljava/util/function/Function;)Ljava/util/Comparator;

    move-result-object v2

    invoke-static {p1, p4, v2}, Ljava/util/Collections;->binarySearch(Ljava/util/List;Ljava/lang/Object;Ljava/util/Comparator;)I
    ...
    invoke-interface {v4, p4}, Ljava/nio/file/Path;->resolve(Ljava/nio/file/Path;)Ljava/nio/file/Path;

    move-result-object v2

    invoke-interface {v5, p4}, Ljava/nio/file/Path;->resolve(Ljava/nio/file/Path;)Ljava/nio/file/Path;

    move-result-object v3

    invoke-static {v2, v3, v7, p3}, Lorg/apache/commons/io/file/PathUtils;->fileContentEquals(Ljava/nio/file/Path;Ljava/nio/file/Path;[Ljava/nio/file/LinkOption;[Ljava/nio/file/OpenOption;)Z
    ...
    invoke-interface {v5, p4}, Ljava/nio/file/Path;->resolve(Ljava/lang/String;)Ljava/nio/file/Path;

    move-result-object p4

    invoke-static {v2, p4, v7, p3}, Lorg/apache/commons/io/file/PathUtils;->fileContentEquals(Ljava/nio/file/Path;Ljava/nio/file/Path;[Ljava/nio/file/LinkOption;[Ljava/nio/file/OpenOption;)Z
...
.method public static getPath(Ljava/lang/String;Ljava/lang/String;)Ljava/nio/file/Path;
    .registers 3
...
.method static synthetic lambda$walk$4(Lorg/apache/commons/io/file/PathFilter;ZLjava/nio/file/Path;)Z
    ...
    invoke-static {p2, p1}, Lorg/apache/commons/io/file/PathUtils;->readBasicFileAttributes(Ljava/nio/file/Path;[Ljava/nio/file/LinkOption;)Ljava/nio/file/attribute/BasicFileAttributes;
