...
.method public constructor <init>(Ljava/io/Writer;Ljava/nio/charset/Charset;IZ)V
    ...
    invoke-static {p2}, Lorg/apache/commons/io/output/WriterOutputStream;->newDecoder(Ljava/nio/charset/Charset;)Ljava/nio/charset/CharsetDecoder;
...
.method private constructor <init>(Lorg/apache/commons/io/output/WriterOutputStream$Builder;)V
    .registers 5
    ...
    invoke-virtual {p1}, Lorg/apache/commons/io/output/WriterOutputStream$Builder;->getWriter()Ljava/io/Writer;

    move-result-object v0

    invoke-static {p1}, Lorg/apache/commons/io/output/WriterOutputStream$Builder;->access$200(Lorg/apache/commons/io/output/WriterOutputStream$Builder;)Ljava/nio/charset/CharsetDecoder;

    move-result-object v1

    invoke-virtual {p1}, Lorg/apache/commons/io/output/WriterOutputStream$Builder;->getBufferSize()I

    move-result v2

    invoke-static {p1}, Lorg/apache/commons/io/output/WriterOutputStream$Builder;->access$300(Lorg/apache/commons/io/output/WriterOutputStream$Builder;)Z

    move-result p1

    invoke-direct {p0, v0, v1, v2, p1}, Lorg/apache/commons/io/output/WriterOutputStream;-><init>(Ljava/io/Writer;Ljava/nio/charset/CharsetDecoder;IZ)V

    return-void
.end method

.method synthetic constructor <init>(Lorg/apache/commons/io/output/WriterOutputStream$Builder;Lorg/apache/commons/io/output/WriterOutputStream$1;)V
    .registers 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-direct {p0, p1}, Lorg/apache/commons/io/output/WriterOutputStream;-><init>(Lorg/apache/commons/io/output/WriterOutputStream$Builder;)V

    return-void
.end method

.method static synthetic access$100(Ljava/nio/charset/Charset;)Ljava/nio/charset/CharsetDecoder;
    .registers 1

    invoke-static {p0}, Lorg/apache/commons/io/output/WriterOutputStream;->newDecoder(Ljava/nio/charset/Charset;)Ljava/nio/charset/CharsetDecoder;
...
.method private static newDecoder(Ljava/nio/charset/Charset;)Ljava/nio/charset/CharsetDecoder;
    .registers 2
