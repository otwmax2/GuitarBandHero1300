.class public final Lcom/bezets/gitarindo/cropper/CropImage;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/bezets/gitarindo/cropper/CropImage$ActivityBuilder;,
...
# static fields
.field public static final CROP_IMAGE_ACTIVITY_REQUEST_CODE:I = 0x7b

.field public static final CROP_IMAGE_ACTIVITY_REQUEST_CODE1:I = 0x1c8
...
.method public static activity(Landroid/net/Uri;)Lcom/bezets/gitarindo/cropper/CropImage$ActivityBuilder;
    .registers 3

    new-instance v0, Lcom/bezets/gitarindo/cropper/CropImage$ActivityBuilder;

    const/4 v1, 0x0

    invoke-direct {v0, p0, v1}, Lcom/bezets/gitarindo/cropper/CropImage$ActivityBuilder;-><init>(Landroid/net/Uri;Lcom/bezets/gitarindo/cropper/CropImage$1;)V

    return-object v0
.end method

.method public static getActivityResult(Landroid/content/Intent;)Lcom/bezets/gitarindo/cropper/CropImage$ActivityResult;
    .registers 2
    ...
    check-cast p0, Lcom/bezets/gitarindo/cropper/CropImage$ActivityResult;
...
.method public static getPickImageChooserIntent(Landroid/content/Context;)Landroid/content/Intent;
    ...
    sget v0, Lcom/bezets/gitarindo/R$string;->pick_image_intent_chooser_title:I
    ...
    invoke-static {p0, v0, v1}, Lcom/bezets/gitarindo/cropper/CropImage;->getPickImageChooserIntent(Landroid/content/Context;Ljava/lang/CharSequence;Z)Landroid/content/Intent;
...
.method public static getPickImageChooserIntent(Landroid/content/Context;Ljava/lang/CharSequence;Z)Landroid/content/Intent;
    ...
    invoke-static {p0, v1, p2}, Lcom/bezets/gitarindo/cropper/CropImage;->getGalleryIntents(Landroid/content/pm/PackageManager;Ljava/lang/String;Z)Ljava/util/List;
...
.method public static getPickImageResultUri(Landroid/content/Context;Landroid/content/Intent;)Landroid/net/Uri;
    ...
    :cond_2
    :goto_0
    invoke-static {p0}, Lcom/bezets/gitarindo/cropper/CropImage;->getCaptureImageOutputUri(Landroid/content/Context;)Landroid/net/Uri;
...
.method public static isExplicitCameraPermissionRequired(Landroid/content/Context;)Z
    ...
    invoke-static {p0, v0}, Lcom/bezets/gitarindo/cropper/CropImage;->hasPermissionInManifest(Landroid/content/Context;Ljava/lang/String;)Z
...
.method public static isReadExternalStoragePermissionsRequired(Landroid/content/Context;Landroid/net/Uri;)Z
    ...
    invoke-static {p0, p1}, Lcom/bezets/gitarindo/cropper/CropImage;->isUriRequiresPermissions(Landroid/content/Context;Landroid/net/Uri;)Z
...
.method public static startPickImageActivity(Landroid/app/Activity;)V
    ...
    invoke-static {p0}, Lcom/bezets/gitarindo/cropper/CropImage;->getPickImageChooserIntent(Landroid/content/Context;)Landroid/content/Intent;
