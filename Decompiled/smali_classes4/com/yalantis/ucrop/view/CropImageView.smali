...
.method public cropAndSaveImage(Landroid/graphics/Bitmap$CompressFormat;ILcom/yalantis/ucrop/callback/BitmapCropCallback;)V
    ...
    invoke-virtual {v1, p0, v0}, Lcom/yalantis/ucrop/task/BitmapCropTask;->executeOnExecutor(Ljava/util/concurrent/Executor;[Ljava/lang/Object;)Landroid/os/AsyncTask;
...
.method public setImageToWrapCropBounds(Z)V
    ...
    invoke-virtual {v3, v2}, Lcom/yalantis/ucrop/view/CropImageView;->post(Ljava/lang/Runnable;)Z
    ...
    invoke-virtual {v3, v8, v9}, Lcom/yalantis/ucrop/view/CropImageView;->postTranslate(FF)V
...
.method protected zoomImageToPosition(FFFJ)V
    ...
    invoke-virtual {v1, v0}, Lcom/yalantis/ucrop/view/CropImageView;->post(Ljava/lang/Runnable;)Z
