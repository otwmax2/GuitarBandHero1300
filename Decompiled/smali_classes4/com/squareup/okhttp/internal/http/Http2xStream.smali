...
.method static constructor <clinit>()V
    ...
    sget-object v16, Lcom/squareup/okhttp/internal/framed/Header;->TARGET_HOST:Lokio/ByteString;

    aput-object v16, v9, v15

    const/16 v15, 0xd

    sget-object v16, Lcom/squareup/okhttp/internal/framed/Header;->VERSION:Lokio/ByteString;
    ...
    new-array v9, v10, [Lokio/ByteString;
...
.method public cancel()V
    ...
    iget-object p0, p0, Lcom/squareup/okhttp/internal/http/Http2xStream;->stream:Lcom/squareup/okhttp/internal/framed/FramedStream;
...
.method public createRequestBody(Lcom/squareup/okhttp/Request;J)Lokio/Sink;
    ...
    invoke-virtual {p0}, Lcom/squareup/okhttp/internal/framed/FramedStream;->getSink()Lokio/Sink;
...
.method public openResponseBody(Lcom/squareup/okhttp/Response;)Lcom/squareup/okhttp/ResponseBody;
    ...
    new-instance p0, Lcom/squareup/okhttp/internal/http/RealResponseBody;
    ...
    invoke-direct {p0, p1, v0}, Lcom/squareup/okhttp/internal/http/RealResponseBody;-><init>(Lcom/squareup/okhttp/Headers;Lokio/BufferedSource;)V
...
.method public readResponseHeaders()Lcom/squareup/okhttp/Response$Builder;
    ...
    invoke-virtual {p0}, Lcom/squareup/okhttp/internal/framed/FramedStream;->getResponseHeaders()Ljava/util/List;

    move-result-object p0

    invoke-static {p0}, Lcom/squareup/okhttp/internal/http/Http2xStream;->readHttp2HeadersList(Ljava/util/List;)Lcom/squareup/okhttp/Response$Builder;
    ...
    invoke-static {p0}, Lcom/squareup/okhttp/internal/http/Http2xStream;->readSpdy3HeadersList(Ljava/util/List;)Lcom/squareup/okhttp/Response$Builder;
...
.method public writeRequestHeaders(Lcom/squareup/okhttp/Request;)V
    ...
    iget-object p0, p0, Lcom/squareup/okhttp/internal/http/Http2xStream;->httpEngine:Lcom/squareup/okhttp/internal/http/HttpEngine;

    iget-object p0, p0, Lcom/squareup/okhttp/internal/http/HttpEngine;->client:Lcom/squareup/okhttp/OkHttpClient;

    invoke-virtual {p0}, Lcom/squareup/okhttp/OkHttpClient;->getWriteTimeout()I
