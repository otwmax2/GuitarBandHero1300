...
.method private checkNoDexterRequestOngoing()V
    ...
    :cond_0
    new-instance p0, Lcom/karumi/dexter/DexterException;

    sget-object v0, Lcom/karumi/dexter/listener/DexterError;->REQUEST_ONGOING:Lcom/karumi/dexter/listener/DexterError;

    const-string v1, "Only one Dexter request at a time is allowed"

    invoke-direct {p0, v1, v0}, Lcom/karumi/dexter/DexterException;-><init>(Ljava/lang/String;Lcom/karumi/dexter/listener/DexterError;)V
...
.method private checkRequestSomePermission(Ljava/util/Collection;)V
    ...
    sget-object p1, Lcom/karumi/dexter/listener/DexterError;->NO_PERMISSIONS_REQUESTED:Lcom/karumi/dexter/listener/DexterError;

    const-string v0, "Dexter has to be called with at least one permission"

    invoke-direct {p0, v0, p1}, Lcom/karumi/dexter/DexterException;-><init>(Ljava/lang/String;Lcom/karumi/dexter/listener/DexterError;)V
...
.method private checkSelfPermission(Landroid/app/Activity;Ljava/lang/String;)I
    ...
    :try_start_0
    iget-object p0, p0, Lcom/karumi/dexter/DexterInstance;->androidPermissionService:Lcom/karumi/dexter/AndroidPermissionService;

    invoke-virtual {p0, p1, p2}, Lcom/karumi/dexter/AndroidPermissionService;->checkSelfPermission(Landroid/content/Context;Ljava/lang/String;)I
...
.method private handleDeniedPermissions(Ljava/util/Collection;)V
    ...
    iget-object p0, p0, Lcom/karumi/dexter/DexterInstance;->listener:Lcom/karumi/dexter/listener/multi/MultiplePermissionsListener;

    invoke-interface {p0, v0, p1}, Lcom/karumi/dexter/listener/multi/MultiplePermissionsListener;->onPermissionRationaleShouldBeShown(Ljava/util/List;Lcom/karumi/dexter/PermissionToken;)V
...
.method private onPermissionsChecked(Ljava/util/Collection;)V
    ...
    iget-object p0, p0, Lcom/karumi/dexter/DexterInstance;->multiplePermissionsReport:Lcom/karumi/dexter/MultiplePermissionsReport;

    invoke-interface {p1, p0}, Lcom/karumi/dexter/listener/multi/MultiplePermissionsListener;->onPermissionsChecked(Lcom/karumi/dexter/MultiplePermissionsReport;)V
...
.method private requestPermissionsToSystem(Ljava/util/Collection;)V
    ...
    :cond_0
    iget-object p0, p0, Lcom/karumi/dexter/DexterInstance;->isShowingNativeDialog:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method private startTransparentActivityIfNeeded()V
    ...
    :cond_0
    iget-object p0, p0, Lcom/karumi/dexter/DexterInstance;->intentProvider:Lcom/karumi/dexter/IntentProvider;

    const-class v1, Lcom/karumi/dexter/DexterActivity;

    invoke-virtual {p0, v0, v1}, Lcom/karumi/dexter/IntentProvider;->get(Landroid/content/Context;Ljava/lang/Class;)Landroid/content/Intent;
