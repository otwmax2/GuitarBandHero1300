...
.method decodeTo([BLjava/lang/CharSequence;)I
    ...
    iget-object v8, p0, Lcom/google/common/io/BaseEncoding$StandardBaseEncoding;->alphabet:Lcom/google/common/io/BaseEncoding$Alphabet;

    if-ge v5, v7, :cond_1

    iget v7, v8, Lcom/google/common/io/BaseEncoding$Alphabet;->bitsPerChar:I
    ...
    :cond_1
    iget v5, v8, Lcom/google/common/io/BaseEncoding$Alphabet;->bytesPerChunk:I
